 ...
 */
final class Version20210402102620 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE skill_trainee (skill_id INT NOT NULL, trainee_id INT NOT NULL, INDEX IDX_5C3313CE5585C142 (skill_id), INDEX IDX_5C3313CE36C682D0 (trainee_id), PRIMARY KEY(skill_id, trainee_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
